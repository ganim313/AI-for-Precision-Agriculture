...
def main():
    ...
    file_path = 'C:/Users/Md Ganim/Desktop/Program/AI_project/Final/Dataset/FinalCrop_Reommenationn.csv'  # Update this with your CSV file path
    target_column = 'label'  # Update this with your target column name
